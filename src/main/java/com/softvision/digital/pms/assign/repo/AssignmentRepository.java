...
public class AssignmentRepository extends AbstractRepository {
	...
	public List<EmployeeAssignmentDto> getAllAssignments(int cycleId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_MANAGER_ALL_CYCLE_ASSIGNMENTS, new Object[] {cycleId},
	...
	public List<EmployeePhaseAssignmentDto> getAllAssignments(int cycleId, int phaseId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_MANAGER_ALL_PHASE_ASSIGNMENTS, new Object[] { cycleId, phaseId },
