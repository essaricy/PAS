...
public class AssignmentRepositorySql {
	...
	private static final String AND_APPR_PHASE_ID = "and appr_phase.id=? ";

	private AssignmentRepositorySql() {}
    ...
    public static final String SELECT_PHASE_ASSIGNMENTS_BY_CYCLE_BY_EMPLOYEE_ID = SELECT_PHASE_ASSIGNMENTS +
            "inner join appr_cycle " + 
