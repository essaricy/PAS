...
public class ManagerAssignmentRepository extends AbstractRepository {
	...
	public List<EmployeeAssignmentDto> getAssignmentsByAssignedByByCycle(int assignedBy, int cycleId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_CYCLE_ASSIGNMENTS_ASSIGNED_BY,
				new Object[] { assignedBy, cycleId }, new RowMapper<EmployeeAssignmentDto>() {
					public EmployeeAssignmentDto mapRow(ResultSet rs, int rowNum) throws SQLException {
						return AssignmentSqlAssembler.getEmployeeAssignmentForCycle(rs);
					}
				});
	}

	public List<EmployeeAssignmentDto> getAssignmentsBySubmittedToByCycle(int submittedTo, int cycleId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_CYCLE_ASSIGNMENTS_SUBMITTED_TO,
				new Object[] { submittedTo, cycleId }, new RowMapper<EmployeeAssignmentDto>() {
					public EmployeeAssignmentDto mapRow(ResultSet rs, int rowNum) throws SQLException {
						return AssignmentSqlAssembler.getEmployeeAssignmentForCycle(rs);
					}
				});
	...
	public List<EmployeePhaseAssignmentDto> getAssignmentsByAssignedByByPhase(int assignedBy, int cycleId, int phaseId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_PHASE_ASSIGNMENTS_ASSIGNED_BY,
				new Object[] { assignedBy, cycleId, phaseId }, new RowMapper<EmployeePhaseAssignmentDto>() {
	...
	public List<EmployeePhaseAssignmentDto> getPhaseAssignmentsByCycleByEmployeeId(long cycleId, int employeeId) {
		return jdbcTemplate.query(AssignmentRepositorySql.SELECT_PHASE_ASSIGNMENTS_BY_CYCLE_BY_EMPLOYEE_ID,
				new Object[] { cycleId, employeeId }, new RowMapper<EmployeePhaseAssignmentDto>() {
					public EmployeePhaseAssignmentDto mapRow(ResultSet rs, int rowNum) throws SQLException {
						return AssignmentSqlAssembler.getEmployeePhaseAssignment(rs);
					}
				});
