...
@Data
@Validated
public class PhaseAssessHeaderDto implements Serializable {
	...
	@Valid
	private List<PhaseAssessDetailDto> phaseAssessDetails;

	@Override
	public String toString() {
		return "PhaseAssessHeaderDto [id=" + id + ", assignId=" + assignId + ", status=" + status + ", assessDate="
