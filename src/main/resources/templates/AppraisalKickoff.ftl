		...
		<tr>
			<td align="center" valign="top"
				...
				<table border="0" cellpadding="0" cellspacing="0" align="center"
					...
					<!-- End of WRAPPER -->
				</table> <!-- WRAPPER / CONTEINER --> <!-- Set conteiner background color -->
				<table border="0" cellpadding="0" cellspacing="0" align="center"
					...
					<tr>
						<td align="center" valign="top"
							style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 24px; font-weight: bold; line-height: 130%; padding-top: 10px; color: #000000; font-family: sans-serif;">
							<!-- LOGO --> <a target="_blank" style="text-decoration: none;"
							href="${imagePath}"><img border="0" vspace="0" hspace="0"
								src="${imagePath}" width="90" height="80"
								style="float: left; color: #000000; font-size: 10px; margin: 0; padding: 0; outline: none; text-decoration: none; -ms-interpolation-mode: bicubic; border: none; display: block;" /></a>
					...
					<tr>
						<td align="center" valign="top"
							style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; padding-top: 25px;"><hr
					...
					<tr>
						<td valign="top"
							...
							<b>Dear Softvisioners,</b>
							<p>
								We're proud to announce the Appraisal cycle for the year <b>
									${cycle} </b> begins from today. Your managers will send your
								Goals, competencies, etc to you. We request you to fill in and
								submit them within provided time frames.
							</p>
						</td>
					</tr>
							...
							<table border="0" cellpadding="0" cellspacing="0" align="center"
								...
								<tr>
									<td align="center" valign="middle"
										...
										href="${url}">Go to my self appraisal</a></td>
								</tr>
							</table>
						</td>
					</tr>
					...
					<tr>
						<td valign="top"
							style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 4.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%; padding-top: 25px; color: #000000; font-family: sans-serif;">
				...
				</table> <!-- WRAPPER --> <!-- Set wrapper width (twice) -->
				<table border="0" cellpadding="0" cellspacing="0" align="center"
					width="560"
					style="border-collapse: collapse; border-spacing: 0; padding: 0; width: inherit; max-width: 560px;">
								...
								<tr>
									...
									<td>
										<div
											...
											<div>
												&#169; 2018 <a href="https://www.softvision.com/"
													target="_blank"
													style="text-decoration: none; color: #828282;"><span
													style="color: #828282;">Softvision</span></a>.
												All&nbsp;rights&nbsp;reserved.
											</div>
										</div>
									</td>
