...
<%@ page import="com.softvision.digital.pms.appraisal.constant.AppraisalCycleStatus" %>
...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<%=request.getContextPath()%>/dashboard" style="position: relative; top: -5px;">
       	      <img src="<%=request.getContextPath()%>/images/softvision-logo-white-150.svg" alt="Logo" style="width: 150px;">
            </a>
        </div>
