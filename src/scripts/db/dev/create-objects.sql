...
values(1,'KICK_OFF','AppraisalKickoff.ftl','Appraisal Kick off - {0} !!!','http://localhost:9000/','pms@softvision.com','offshoresoftvision@softvision.com',null);
...
Appraisal
Accepted!!','http://localhost:9000/',null,null,'pms@softvision.com');

-- HR for group?
insert into email_template 
values(8,'EMP_REJECTED','EmploeeRejected.ftl','[{0},{1}]   [{2}] Self 
Appraisal
Rejected!!','http://localhost:9000/',null,null,'pms@softvision.com');

-- HR for group?
insert into email_template 
values(9,'UPDATE_REVIEW','UpdateReviewEmp.ftl','[{0},{1}]   [{2}] Self 
Appraisal
Re-visited!!','http://localhost:9000/',null,null,'pms@softvision.com');
...
-- no button
insert into email_template
values(12,'CYCLE_CONCLUDE','Appraisalconcluded.ftl','Appraisal {0} Has Been Conclude!!!','','pms@softvision.com','offshoresoftvision@softvision.com',null);
