...
---- ######################### email_template for DEV
insert into email_template values(1,'KICK_OFF','AppraisalKickoff.ftl','Appraisal Kick off - {0} !!!','http://localhost:9000/','srikanth.kumar@softvision.com','srikanth.kumar@softvision.com',null);
insert into email_template values(2,'EMPLOYEE_ENABLE','EmployeeEnable.ftl','[{0},{1}]   [{2}] Self Appraisal Form Available!!','http://localhost:9000/',null,null,null);
insert into email_template values(3,'EMPLOYEE_SUBMITED','EmployeeSubmitted.ftl','[{0},{1}] [{2}] Self Appraisal Submitted!!','http://localhost:9000/',null,null,null);
insert into email_template values(4,'MGR_TO_EMP_REMINDER','ManagerToEmployeeReminder.ftl','[{0},{1}] [{2}] Self Appraisal Pending Reminder!!','http://localhost:9000/',null,null,null);
insert into email_template values(5,'MANAGER_REVIEW','ManagerReviewCompleted.ftl','[{0},{1}] [{2}] Self Appraisal Reviewed!!','http://localhost:9000/',null,null,null);
insert into email_template values(6,'MANAGER_FROZEN','ManagerReviewFrozen.ftl','[{0},{1}] [{2}] Self Appraisal Concluded!!','http://localhost:9000/',null,null,null);
insert into email_template values(7,'EMP_ACCEPTED','EmployeeAccepted.ftl','[{0},{1}]   [{2}] Self Appraisal Accepted!!','http://localhost:9000/',null,null,'srikanth.kumar@softvision.com');
insert into email_template values(8,'EMP_REJECTED','EmployeeRejected.ftl','[{0},{1}]   [{2}] Self Appraisal Rejected!!','http://localhost:9000/',null,null,'srikanth.kumar@softvision.com');
insert into email_template values(9,'UPDATE_REVIEW','UpdateReviewEmp.ftl','[{0},{1}]   [{2}] Self Appraisal Re-visited!!','http://localhost:9000/',null,null,'srikanth.kumar@softvision.com');
insert into email_template values(10,'HR_TO_EMP_REM','HrToEmployeeReminder.ftl','[{0},{1}] [{2}] Self Appraisal Pending Reminder!!','http://localhost:9000/',null,null,null);
insert into email_template values(11,'HR_TO_MGR_REM','HrToManagerReminder.ftl','[{0},{1}] [{2}] Self Appraisal Review Pending!!','http://localhost:9000/',null,null,null);
insert into email_template values(12,'CYCLE_CONCLUDE','AppraisalConcluded.ftl','Appraisal {0} Has Been Conclude!!!','','srikanth.kumar@softvision.com','srikanth.kumar@softvision.com',null);
insert into email_template values(13,'CHANGE_MGR','ChangeManager.ftl','[{0},{1}]   [{2}] Assign Manager Changed!!','http://localhost:9000/',null,null,null);
