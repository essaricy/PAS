...
insert into appr_phase (ID, CYCLE_ID, NAME, START_DATE, END_DATE) values (nextval('appr_period_ID_SEQ'), (select ID from appr_cycle where name='2017-18'), 'FY', '2017-01-01', '2018-04-30');
insert into appr_phase (ID, CYCLE_ID, NAME, START_DATE, END_DATE) values (nextval('appr_period_ID_SEQ'), (select ID from appr_cycle where name='2018'), 'Q1', '2018-05-01', '2018-06-30');
insert into appr_phase (ID, CYCLE_ID, NAME, START_DATE, END_DATE) values (nextval('appr_period_ID_SEQ'), (select ID from appr_cycle where name='2018'), 'Q2', '2018-07-01', '2018-09-30');
insert into appr_phase (ID, CYCLE_ID, NAME, START_DATE, END_DATE) values (nextval('appr_period_ID_SEQ'), (select ID from appr_cycle where name='2018'), 'Q3', '2018-10-01', '2018-12-31');
