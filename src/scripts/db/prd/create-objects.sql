...
insert into email_template values(1,'KICK_OFF','AppraisalKickoff.ftl','Appraisal Kick off - {0} !!!','http://pms.softvision.com/','pms@softvision.com','pms@softvision.com',null);
insert into email_template values(2,'EMPLOYEE_ENABLE','EmployeeEnable.ftl','[{0},{1}]   [{2}] Self Appraisal Form Available!!','http://pms.softvision.com/',null,null,null);
...
insert into email_template values(4,'MGR_TO_EMP_REMINDER','ManagerToEmployeeReminder.ftl','[{0},{1}] [{2}] Self Appraisal Pending Reminder!!','http://pms.softvision.com/',null,null,null);
...
insert into email_template values(7,'EMP_ACCEPTED','EmployeeAccepted.ftl','[{0},{1}]   [{2}] Self Appraisal Accepted!!','http://pms.softvision.com/',null,null,null);
insert into email_template values(8,'EMP_REJECTED','EmployeeRejected.ftl','[{0},{1}]   [{2}] Self Appraisal Rejected!!','http://pms.softvision.com/',null,null,null);
...
insert into email_template values(10,'HR_TO_EMP_REM','HrToEmployeeReminder.ftl','[{0},{1}] [{2}] Self Appraisal Pending Reminder!!','http://pms.softvision.com/',null,null,null);
insert into email_template values(11,'HR_TO_MGR_REM','HrToManagerReminder.ftl','[{0},{1}] [{2}] Self Appraisal Review Pending!!','http://pms.softvision.com/',null,null,null);
...
insert into email_template values(13,'CHANGE_MGR','ChangeManager.ftl','[{0},{1}]   [{2}] Assign Manager Changed!!','http://pms.softvision.com/',null,null,null);
